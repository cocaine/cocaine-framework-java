...
JNIEXPORT void JNICALL Java_cocaine_dealer_Dealer_delete
(JNIEnv *, jobject, jlong dealer_ptr) {
    dealer_t * dealer = (dealer_t *) dealer_ptr;
    delete dealer;
}

JNIEXPORT jlong JNICALL Java_cocaine_dealer_Dealer_init(JNIEnv *env,
...
JNIEXPORT jlong JNICALL Java_cocaine_dealer_Dealer_sendMessage(
